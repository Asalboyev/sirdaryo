...
class PostsController extends Controller
{
    ...
    //    $requestData['slug'] = Str::slug($request->title_uz);  // Post modelida saving method
       ...
       return redirect()->route('admin.posts.index')->with('success', 'Post updated succuessfuly');
    }
    ...
    {
        Post::destroy($id);
        return redirect()->route('admin.posts.index')->with('success', 'Post deleted succuessfuly');
